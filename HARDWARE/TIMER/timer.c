...
void servo_init(u16 arr,u16 psc)
{
	...
	GPIO_PinRemapConfig(GPIO_PartialRemap_TIM3, ENABLE); //Timer3部分重映射  TIM3_CH3 4->PB0 1     
 
   //设置该引脚为复用输出功能,输出TIM3 CH2的PWM脉冲波形	GPIOB.01
   ...
   //初始化TIM3
	...
	//GPIO_PinRemapConfig(GPIO_PartialRemap2_TIM2, ENABLE); //Timer3部分重映射  TIM3_CH1 2->PA0 1     
